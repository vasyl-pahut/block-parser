...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content__ = __webpack_require__(70);
...
const covertClasses = classNames => {
  const classes = classNames.split(' ').map(className => className.includes('-') ? `css['${className}']` : `css.${className}`).join(', ');
  ...
  Text: {
    convert: dom => {
      ...
      elements.forEach((element, index) => {
        ...
        __WEBPACK_IMPORTED_MODULE_0__content__["a" /* default */].set(`text-${index}`, element.innerText.trim().replace(/\n+|\t+/igm, () => ' ').replace(/ {2,}/igm, () => ' '));
        element.innerHTML = '';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_clipboard__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__custom_elements__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dom_elements__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__content__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__block_template__ = __webpack_require__(364);
...
const cleanCode = () => {
  __WEBPACK_IMPORTED_MODULE_3__dom_elements__["c" /* $codeOutput */].innerHTML = '';
  __WEBPACK_IMPORTED_MODULE_4__content__["a" /* default */].clear();
  Object(__WEBPACK_IMPORTED_MODULE_2__custom_elements__["b" /* clearElements */])();
};

const createCode = code => {
  const blockName = __WEBPACK_IMPORTED_MODULE_3__dom_elements__["a" /* $blockNameInput */].value || 'Block';
...
const getJsx = virtualDom => {
  const text = virtualDom.innerHTML.replace(appTags, replaceTags).replace(closingTags, () => '/>').replace(/data-bind/igm, () => 'bind').replace(/data-picture-class-name="/igm, () => 'pictureClassName').replace(/data-img-class-name="/igm, () => 'imgClassName').replace(/class="/igm, () => 'className=').replace(/cls#}"/igm, () => '}').replace(/xmlns:xlink/igm, () => 'xmlnsLink').replace(/xlink:href/igm, () => 'xlinkHref').replace(/\n/gm, () => '\n\t\t\t').replace(/\t/gm, () => '  ');
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(356), __webpack_require__(358), __webpack_require__(359)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(357)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__custom_elements__ = __webpack_require__(69);
